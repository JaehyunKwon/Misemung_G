...
class GetFindDustThread extends Thread {	//기상청 연결을 위한 스레드
	...
	String[] sDate,sSo2Value,sCoValue,sO3Value,sNo2Value,sPm10Value,sPm25Value,sKhaiValue,sKhaiGrade,sSo2Grade,sCoGrade,sO3Grade,sNo2Grade,sPm10Grade,sPm25Grade;	//예보시간,날짜,온도,풍향,습도,날씨
	boolean bTotalCount,bDate,bSo2Value,bCoValue,bO3Value,bNo2Value,bPm10Value,bPm25Value,bKhaiValue,bKhaiGrade,bSo2Grade,bCoGrade,bO3Grade,bNo2Grade,bPm10Grade,bPm25Grade;	//여긴 저장을 위한 플래그들
	...
	public void run(){
		...
		if(active){
			try{
				...
				String dustUrl=getInfo+getStationFindDust+station+dongName+"&"+infoCnt+"&"+searchDate+"&"+Servicekey+"&ver=1.3";
